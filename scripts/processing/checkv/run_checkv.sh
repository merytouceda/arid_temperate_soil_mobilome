...
source /groups/egornish/mtoucedasuarez/scripts/jobs/mge/base/checkv/config.sh
...
echo "launching checkv.slurm as a job."

JOB_ID=`sbatch --job-name checkv-base -a 1-$NUM_JOB checkv.slurm`
